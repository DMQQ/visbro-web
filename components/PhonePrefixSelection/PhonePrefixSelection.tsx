...
export default function PhonePrefixSelection(props: PhonePrefixSelectionProps) {
  return (
    <div className="m-2">
      ...
      <div
        className={clsx("PhoneContainer bg-zinc-800 rounded-md", {
      ...
      >
        <PhoneInput
          ...
          smartCaret={false}
          className=" py-2 border-1 px-2 rounded-md border-zinc-600"
          placeholder={props.label}
          value={formatPhoneNumberIntl(props.savedValue)}
          onChange={(val) => {
...
// function _PhonePrefixSelection(props: any) {
